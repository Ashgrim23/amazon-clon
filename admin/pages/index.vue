    ...
    <div class="container-fluid browsing-history">
      <div class="row">
        <div class="col-sm-8 col-8">
          ...
          <div class="a-spacing-large"></div>
          <nuxt-link to="/products" class="a-button-buy-again margin-right-10">Add a new product</nuxt-link>
        ...
        <div 
          ...
          <div class="history-box">
            ...
            <div class="a-row">
              ...
              <a href="#" class="a-button-history margin-right-10" @click="onDeleteProduct(product._id,index,product.photo)">Delete</a>
            </div>
...
export default {
  ...
  methods:{
    async onDeleteProduct(id,index,photo){
      try {        
        let response=await this.$axios.$delete(`http://localhost:3000/api/products/${id}`,{data: {deletePhoto:photo}})
        if (response.success){
