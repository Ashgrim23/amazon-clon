            ...
            <div class="row a-histogrm-row">
                ...
                <div>
                  <a href="#">
                    <div class="a-meter 5star">
                      <div class="a-meter-bar a-meter-filled" :style="{width: product.statsRating[5]+'%'}"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-2 pr-0">
                <div class="aok-nowrap text-right">
                  <a href="#">{{product.statsRating[5]}}%</a>
                  <span class="a-letter-space"></span>
                </div>
              </div>
            </div>
            <div class="row a-histogrm-row" style="margin-top: -15px;">
              ...
              <div class="col-md-8 col-sm-8 col-8 pr-0">
                <div>
                  <a href="#">
                    <div class="a-meter 5star">
                      <div class="a-meter-bar a-meter-filled" :style="{width: product.statsRating[4]+'%'}"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-2 pr-0">
                <div class="aok-nowrap text-right">
                  <a href="#">{{product.statsRating[4]}}%</a>
                  <span class="a-letter-space"></span>
                </div>
              </div>
            </div>
            <div class="row a-histogrm-row" style="margin-top: -15px;">
              ...
              <div class="col-md-8 col-sm-8 col-8 pr-0">
                <div>
                  <a href="#">
                    <div class="a-meter 5star">
                      <div class="a-meter-bar a-meter-filled" :style="{width: product.statsRating[3]+'%'}"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-2 pr-0">
                <div class="aok-nowrap text-right">
                  <a href="#">{{product.statsRating[3]}}%</a>
                  <span class="a-letter-space"></span>
                </div>
              </div>
            </div>
            <div class="row a-histogrm-row" style="margin-top: -15px;">
              ...
              <div class="col-md-8 col-sm-8 col-8 pr-0">
                <div>
                  <a href="#">
                    <div class="a-meter 5star">
                      <div class="a-meter-bar a-meter-filled" :style="{width: product.statsRating[2]+'%'}"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-2 pr-0">
                <div class="aok-nowrap text-right">
                  <a href="#">{{product.statsRating[2]}}%</a>
                  <span class="a-letter-space"></span>
                </div>
              </div>
            </div>
            <div class="row a-histogrm-row" style="margin-top: -15px;">
              ...
              <div class="col-md-8 col-sm-8 col-8 pr-0">
                <div>
                  <a href="#">
                    <div class="a-meter 5star">
                      <div class="a-meter-bar a-meter-filled" :style="{width: product.statsRating[1]+'%'}"></div>
                    </div>
                  </a>
                </div>
              </div>
              <div class="col-md-2 col-sm-2 col-2 pr-0">
                <div class="aok-nowrap text-right">
                  <a href="#">{{product.statsRating[1]}}%</a>
                  <span class="a-letter-space"></span>
                </div>
              </div>
            </div>
